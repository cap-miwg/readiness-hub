...
The What's New panel on the Home page is built from this file at build time.
Format: one `## version` heading per release, `### area` subheadings, short
plain-language entries members can understand.
...
- Home is now your page: My Progress (your next promotion requirement,
  ...
  it meets), plus announcements and release notes.

### Unit Overview
- A ranked Needs Attention queue leads the page: the three to five things
  worth acting on this week, each with a link that goes there.
- Sections are collapsible and remember your layout; collapsed sections
  still show their score, state, and alert count.
- Participation: meeting attendance trends from the CAPWATCH attendance log.
- Logistics: vehicle and equipment status for units that track them.
